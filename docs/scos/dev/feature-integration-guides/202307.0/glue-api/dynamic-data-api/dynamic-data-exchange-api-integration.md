...
redirect_from: 
    - /docs/scos/dev/feature-integration-guides/202304.0/glue-api/dynamic-data-api/dynamic-data-exchange-api-integration.html
...
3. The Dynamic Data Exchange API provides a logging mechanism to capture important information about requests and any thrown exceptions. 
...
Add configurations for dynamic entities. In order to do that follow the instructions here [how to configure Dynamic Data Exchange API](/docs/scos/dev/glue-api-guides/{{page.version}}/dynamic-data-api/how-to-guides/how-to-configure-dynamic-data-exchange-api.html)  
...
If everything is set up correctly, you can operate with the data. Follow this link to discover how to perform it:[How to send request in Dynamic Data Exchange API](/docs/scos/dev/glue-api-guides/{{page.version}}/dynamic-data-api/how-to-guides/how-to-send-request-in-dynamic-data-exchange-api.html)
